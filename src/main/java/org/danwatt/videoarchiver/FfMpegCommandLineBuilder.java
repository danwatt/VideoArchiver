...
public class FfMpegCommandLineBuilder {
	...
	public static CommandLine buildCommandLine(File file, String output, ArchiverConfiguration config) {
		// Setting defaultSetting = config.getSetting("default");
		// System.out.println("Looking for specific setting for " +
		// file.getFormatIdentifier());
		// Setting specificSetting =
		// config.getSetting(file.getFormatIdentifier());
		...
		// }
		// String vScale = defaultIfBlank(defaultSetting.getVideoScale(),
		// specificSetting.getVideoScale());
		// String qScale =
		// defaultIfBlank(defaultSetting.getVideoQualityFactor(),
		// specificSetting.getVideoQualityFactor());
		// String vBitrate = defaultIfBlank(defaultSetting.getVideoBitrate(),
		// specificSetting.getVideoBitrate());
		// String aBitrate = defaultIfBlank(defaultSetting.getAudioBitrate(),
		// specificSetting.getAudioBitrate());
		// try {
		// System.out.println(new
		// ObjectMapper().writeValueAsString(specificSetting));
